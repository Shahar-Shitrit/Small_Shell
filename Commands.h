...
public:
  ...
  virtual ~Command(); // need to delete args by hand (malloced by _parseCommandLine)
...
public:
  ...
  { 
    ...
    pid_t job_id;
    pid_t proccess_id;
    time_t init_time; //time got into the list
    bool is_stopped; 
    bool is_finished; // not needed now?
...
public:
 class TimedEntry{
    ...
    pid_t pid_to_kill; //pid of his brother to be kill
...
public:
  ...
  //const char* getCurrCmdLine() const; ///changed
  //void setCurrCmdLine(const char* cmd);  ///changed
